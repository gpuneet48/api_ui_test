...
public class RESTSteps {
    ...
    public RESTSteps (APIStepData stepsData){
        this.apiStepData= stepsData;
    }
    ...
    private static String API_KEY, BASE_URL;
    ...
    @Given(":Convert them to bolivian Boliviano")
    public void convertTheCurrencies() {
    ...
    public void fetchAndVerifyCurrencyInfo() {
    ...
    public void fetchFirstTenCurrencies() {
    ...
    @Given(":Verify that currencies have 'mineable' tag")
    public void verifyCurrencyTags() {
